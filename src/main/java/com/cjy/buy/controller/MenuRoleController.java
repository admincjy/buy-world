...
import com.cjy.buy.service.MenuRoleService;
...
public class MenuRoleController {
    ...
    @Autowired
    private MenuRoleService targetService;
     ...
     */
    @RequestMapping("/list")
	public BaseRespData list(@RequestBody PageInfoReqVo<MenuRole> pageInfoReqVo){
    ...
    public BaseRespData findAll(){
        List<MenuRole> entitys = targetService.selectList();
    ...
    public BaseRespData find(@RequestParam("id") Long id){
        MenuRole entity = targetService.selectById(id);
        BaseRespData baseRespData=new BaseRespData();
    ...
    public BaseRespMsg addItem(@RequestBody MenuRole entity){
    ...
    public BaseRespMsg batchSave(List<MenuRole> entitys){
    ...
    public BaseRespMsg update(@RequestBody MenuRole entity){
    ...
    public BaseRespMsg batchUpdate(List<MenuRole> entitys){
